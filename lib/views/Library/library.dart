                                                              ...
                                                              child: Padding(
                                                                ...
                                                                child: Column(
                                                                  ...
                                                                  children: <
                                                                      Widget>[
                                                                    Text(
                                                                      _getLibrary[index]['title'].length <=
                                                                              20
                                                                          ? _getLibrary[index]['title']
                                                                              .toString()
                                                                          : _getLibrary[index]['title'].toString().substring(
                                                                              0,
                                                                              20),
                                                                      style:
                                                                          TextStyle(
                                                                        ...
                                                                        children: [
                                                                          Row(
                                                                            children: [
                                                                              ...
                                                                              SizedBox(width: 10),
                                                                              Text(
                                                                                _getLibrary[index]['rating'].toString(),
                                                                                style: TextStyle(
                                                                                  fontSize: 12,
                                                                                  color: kPrimaryWhiteColor,
                                                                                ),
                                                              ...
                                                              child: Padding(
                                                                ...
                                                                child: Column(
                                                                  ...
                                                                  children: <
                                                                      Widget>[
                                                                    Text(
                                                                      _getFavourite[index]['title'].length <=
                                                                              20
                                                                          ? _getFavourite[index]['title']
                                                                              .toString()
                                                                          : _getFavourite[index]['title'].toString().substring(
                                                                              0,
                                                                              20),
                                                                      style:
                                                                          TextStyle(
                                                                        ...
                                                                        children: [
                                                                          Row(
                                                                            children: [
                                                                              ...
                                                                              SizedBox(width: 10),
                                                                              Text(
                                                                                _getFavourite[index]['rating'].toString(),
                                                                                style: TextStyle(
                                                                                  fontSize: 12,
                                                                                  color: kPrimaryWhiteColor,
                                                                                ),
